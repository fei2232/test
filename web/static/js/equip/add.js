...
var equip_add_ops = {
    ...
    eventBind:function () {
        $(".wrap_equip_add .save").click(function () {
            ...
            //参数获取部分
            // 设备编号
            var equip_id_target = $(".wrap_equip_add input[name = equip_id]");
            var equip_id = equip_id_target.val();
            // 所属钻井平台
            var equip_platform_target = $(".wrap_equip_add select[name = equip_platform]");
            var equip_platform = equip_platform_target.val();
            // 监测油品
            var equip_oil_target = $(".wrap_equip_add select[name = equip_oil]");
            var equip_oil = equip_oil_target.val();
            // 罐体长度
            var equip_length_target = $(".wrap_equip_add input[name = equip_length]");
            var equip_length = equip_length_target.val();
            // 罐体宽度
            var equip_width_target = $(".wrap_equip_add input[name = equip_width]");
            var equip_width = equip_width_target.val();
            // 罐体高度
            var equip_height_target = $(".wrap_equip_add input[name = equip_height]");
            var equip_height = equip_height_target.val();
            // 设备状态
            var equip_status_target = $(".wrap_equip_add select[name = equip_status]");
            var equip_status = equip_status_target.val();
            // 备注信息
            var equip_remark_target = $(".wrap_equip_add input[name = equip_remark]");
            ...
            var data = {
                ...
                equip_id:$(".wrap_equip_add input[name = equip_id]").val(),
            };

            $.ajax({
                url:common_ops.buildUrl("/equip/add"),
                type:"POST",
                data:data,
                dataType:"json",
